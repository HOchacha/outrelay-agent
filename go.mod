module github.com/boanlab/outrelay-agent

go 1.25.0

require (
	github.com/boanlab/OutRelay v0.1.0
	github.com/boanlab/outrelay-relay v0.1.0
...
// this replace.
replace (
	github.com/boanlab/OutRelay       => ../OutRelay
	github.com/boanlab/outrelay-relay => ../outrelay-relay
)
